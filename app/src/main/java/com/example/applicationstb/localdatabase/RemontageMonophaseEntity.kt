...
import com.example.applicationstb.model.RemontageMonophase
import com.example.applicationstb.model.RemontageTriphase

@Entity(tableName = "remontage_monophase")
data class RemontageMonophaseEntity(
...
//essais vibratoires
    ...
    fun toMonophase(): RemontageMonophase {
        return RemontageMonophase(
            _id,
            numDevis!!,
            numFiche!!,
            3,
