...
class InfoMoteurFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        viewModel.selection.observe(viewLifecycleOwner, {
            ...
            if (it.numSerie !== null) num.setText(it.numSerie!!)
            ...
            if (it.aspect !== null) aspectExt.setSelection(it.aspect!!)
            if (it.aspectInterieur !== null) aspectBte.setSelection(it.aspectInterieur!!)
        })
